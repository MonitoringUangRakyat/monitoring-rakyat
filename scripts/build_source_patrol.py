...
MAX_PUBLIC_PATROL_ROWS = 5000
AUTONOMOUS_TOOL_MANDATE = {
    "hardcoded": True,
    "mode": "FULL_MANDIRI_PROAKTIF_24_7",
    "rule": "Tim AI Agent wajib memanfaatkan semua sumber/tool yang tersedia untuk mencari, membuat draft, dan mempromosikan kandidat DB sampai Gudang DB tidak kosong.",
    "guard": "Tidak boleh mengklaim final tanpa evidence; draft tetap harus bergerak otomatis ke audit queue dan mapping modul.",
}
